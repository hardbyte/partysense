...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field djs on 'Event'
        m2m_table_name = db.shorten_name(u'event_event_djs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'event.event'], null=False)),
            ('dj', models.ForeignKey(orm[u'dj.dj'], null=False))
        ))
        db.create_unique(m2m_table_name, ['event_id', 'dj_id'])


    def backwards(self, orm):
        # Removing M2M table for field djs on 'Event'
        db.delete_table(db.shorten_name(u'event_event_djs'))
