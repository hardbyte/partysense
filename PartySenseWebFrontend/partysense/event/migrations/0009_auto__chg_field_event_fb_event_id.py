...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.fb_event_id'
        db.alter_column(u'event_event', 'fb_event_id', self.gf('django.db.models.fields.TextField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Event.fb_event_id'
        db.alter_column(u'event_event', 'fb_event_id', self.gf('django.db.models.fields.TextField')(default='', max_length=256))
    ...
    models = {
        ...
        u'event.event': {
            ...
            'fb_event_id': ('django.db.models.fields.TextField', [], {'max_length': '256', 'null': 'True'}),
