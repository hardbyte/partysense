...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'event_location', 'address')


        # Changing field 'Location.name'
        db.alter_column(u'event_location', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):
        # Adding field 'Location.address'
        db.add_column(u'event_location', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=92, blank=True),
                      keep_default=False)


        # Changing field 'Location.name'
        db.alter_column(u'event_location', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
