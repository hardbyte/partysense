...
class GoogleMapsWidget(forms.HiddenInput):
    ...
    def render(self, name, value, attrs=None, choices=()):
        self.attrs['base_point'] = self.attrs.get('base_point', u'37.4419, -122.1419')
        self.attrs['width'] = self.attrs.get('width', 400)
        self.attrs['height'] = self.attrs.get('height', 400)
        self.attrs['country_city'] = self.attrs.get('country_city', u'Sydney, Australia')
        ...
        maps_html = u"""
            ...
            <div>
                ...
                <div style="width: 200px; float: left; margin-left: 20px;">
                    ...
                    <--
                    <input id="address" type="text" value="" placeholder="Venue address"
                           style="float: left; width: 120px; height: 15px; margin-right: 10px;" />
                    -->
