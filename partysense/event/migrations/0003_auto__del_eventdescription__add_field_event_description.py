...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'event_eventdescription')

        # Adding field 'Event.description'
        db.add_column(u'event_event', 'description',
