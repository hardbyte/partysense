...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.fb_event_id'
        db.add_column(u'event_event', 'fb_event_id',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.fb_event_id'
        db.delete_column(u'event_event', 'fb_event_id')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'fb_event_id': ('django.db.models.fields.TextField', [], {'max_length': '256', 'blank': 'True'}),
