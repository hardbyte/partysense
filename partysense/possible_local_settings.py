...
AWS_STORAGE_BUCKET_NAME = 'partysense-test'
POSTGRES_ENABLED = False
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'development_database.db',                      # Or path to database file if using sqlite3.
...
WSGI_APPLICATION = 'partysense.local_wsgi.application'
...
STATIC_ROOT = os.path.join(ROOT_DIR, os.path.pardir, 'tmp')
